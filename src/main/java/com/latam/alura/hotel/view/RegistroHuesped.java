...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	private Integer numeroReservacion;
	...
	public RegistroHuesped() {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel<String>(new String[] { "Seleccione una nacionalidad . . .",
				...
				"canadiense-canadiense", "chileno-chilena", "chino-china", "colombiano-colombiana", "coreano-coreana",
				"costarricense-costarricense", "cubano-cubana", "danés-danesa", "ecuatoriano-ecuatoriana",
				"egipcio-egipcia", "salvadoreño-salvadoreña", "escocés-escocesa", "español-española",
				"estadounidense-estadounidense", "estonio-estonia", "etiope-etiope", "filipino-filipina",
		...
		lblTitulo.setBounds(606, 55, 234, 60);
			...
			public void mouseClicked(MouseEvent e) {
				try {
					if (txtNombre.getText().equals("")) {
						JOptionPane.showMessageDialog(null, "Debe ingresar un(s) nombre(s)");
						txtNombre.requestFocusInWindow();
						return;
					} else if (txtApellido.getText().equals("")) {
						JOptionPane.showMessageDialog(null, "Debe ingresar un(s) apellido(s)");
						txtApellido.requestFocusInWindow();
						return;
					} else if (txtFechaN.getDate() == null) {
						JOptionPane.showMessageDialog(null, "Debe ingresar una fecha");
						txtFechaN.requestFocusInWindow();
						return;
					} else if (txtNacionalidad.getSelectedItem().toString()
							.equals("Seleccione una nacionalidad . . .")) {
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowOpened(WindowEvent e) {
				if (e.getSource() != null) {
					txtNreserva.setText(String.valueOf(numeroReservacion));
				}
			}
		});
	}
	...
	private void guardarRegistro() throws SQLException {
		...
		//numeroReservacion = Integer.parseInt(txtNreserva.getText());

		Huesped miHuesped = new Huesped(nombre, apellido, fechaNacimiento, nacionalidad, telefono, numeroReservacion);
		HuespedController huesped = new HuespedController();
		Integer numerohuesped = huesped.guardarHuesped(miHuesped);

	}
	public void establecerNumeroReserva(Integer numeroReservacion) {
