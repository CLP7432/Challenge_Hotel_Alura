...
import com.latal.alura.hotel.controller.UsuarioController;
...
public class Login extends JFrame {
	...
	private void login() {
		...
		Usuario usuarioLogeado = new Usuario(usuario, contrasena);
		UsuarioController usuarioLog = new UsuarioController();
		boolean validado = usuarioLog.validar(usuarioLogeado);
		if (validado == true) {
